...
<head>
    ...
    {{-- <link href="/vuetify-material-dashboard/css/chunk-09fb2c20.3b924b1b.css" rel="prefetch"> --}}
</head>
<body>
        ...
        <div class="v-application--wrap">
            <header class="v-sheet v-sheet--tile theme--light v-toolbar v-toolbar--absolute v-toolbar--flat v-app-bar transparent" id="app-bar" style="height: 75px; margin-top: 0px; transform: translateY(0px); left: 260px; right: 0px;" data-booted="true">
                <div class="v-toolbar__content" style="height: 75px;">
                    ...
                    <div class="v-input v-input--hide-details theme--light v-text-field v-text-field--is-booted" style="max-width: 355px;" >
                        <div class="v-toolbar__title hidden-sm-and-down font-weight-light"> 
                            @if (Auth::user()->calendar)
                                <small> Current Academic Session:
                                <router-link to="/a/sessions" class="h5 text-dark">{{ Auth::user()->calendar->name }}</router-link></small> 
                            @endif
                        </div>
                    ...
                    {{-- <router-link to="/dashboard/pages/user" class="ml-2 v-btn v-btn--flat v-btn--router v-btn--text theme--light v-size--default" style="min-width: 0px;"><span class="v-btn__content"><i aria-hidden="true" class="v-icon notranslate mdi mdi-account theme--light"></i></span></a> --}}
                </div>
            </header>
            <manager-menu></manager-menu>
            <main class="v-content side-menu-cont" data-booted="true"><div class="v-content__wrap">
                ...
                {{--<footer class="v-footer v-sheet v-sheet--tile theme--light" id="dashboard-core-footer" data-booted="true">
                     <div class="container">style="padding: 75px 0px 0px 260px;"
                        <div class="row no-gutters align-center">
                            ...
                            <div class="col-md-auto col-12">
                                <div class="body-1 font-weight-light pt-6 pt-md-0 text-center"> © 2020, Infoscert Web Experience. </div>
                            </div>
                        </div>
                    </div> 
                </footer>--}}
